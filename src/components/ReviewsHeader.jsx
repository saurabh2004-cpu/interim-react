      ...
      <div className=" min-h-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative ">
            <motion.div
              className="flex items-center justify-center md::justify-center relative top-5 md:top-15 md:right-58 space-x-3 mb-6 sm:mb-8 sm:ml-4 md:ml-8 lg:ml-16"
              variants={fadeInUp}
            >
            ...
            <motion.div className="text-center items-center  text-[#1D322D]" variants={fadeInUp}>
              <h1 className="text-6xl text-[#1D322D]  md:text-[230px] min-w-full  text-center font-black leading-[0.75] tracking-tighter inter-placeholder" style={{ color: "#1D322D" }}>
                Reviews
              </h1>
            </motion.div>
          </div>
