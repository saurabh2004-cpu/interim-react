    ...
    const AwardsSection = () => {
        ...
        return (
            <div className="w-full bg-[#ffffff80] h-screen pt-32 md:pb-20">
                <div className="md:w-[100em] h-[110%] md:h-[45em]   rounded-2xl mx-4 md:mx-auto  bg-[#1f3630] flex flex-col items-center justify-center  py-20 rounded-2xl px-4 ">
                    <div className="  mx-auto">
                        ...
                        >
                            <motion.div
                                className="flex items-center space-x-3 mb-4 relative top-7 left-3   md:top-20 md:right-32  "
                                variants={fadeInUp}
                            >
                            ...
                            <motion.h1
                                className="text-7xl leading-tight md:text-[210px] font-black leading-none text-[#fdfcee] tracking-tighter text-center inter-placeholder"
                                style={{ color: "#fdfcee" }}
                                variants={fadeInUp}
                            >
                                Awards
                        ...
                        <div className="flex items-center justify-center mt-6">
                            <div className="w-full max-w-6xl">
                                {/* Top row - 3 cards */}
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-4 max-w-5xl mx-auto">
                                    {awards.slice(0, 3).map((award, index) => (
                                        <div
                                            key={index}
                                            className="bg-[#FFFFFF0D] rounded-lg p-2  flex items-center space-x-3 sm:space-x-4 transition-colors duration-200 "
                                        >
                                            <Star className="w-6 h-6   bg-[#ffffff1A]  p-2 rounded-lg w-7 h-7 md:w-15 md:h-15 text-orange-300 fill-orange-300 flex-shrink-0" />
                                ...
                                {/* Middle row - 2 cards */}
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6  mb-4 sm:mb-4 max-w-2xl mx-auto">
